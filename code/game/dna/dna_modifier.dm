...
/obj/machinery/dna_scannernew/Initialize(mapload)
	...
	component_parts += new /obj/item/circuitboard/machine/clonescanner(null)
...
/obj/machinery/dna_scannernew/proc/eject_occupant(user, force)
	...
	for(var/obj/O in src)
		if(!istype(O,/obj/item/circuitboard/machine/clonescanner) && !istype(O,/obj/item/stock_parts) && !iscoil(O) && O != beaker)
