...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"TRAIT_CULT_VEIL_SIGHT" = TRAIT_CULT_VEIL_SIGHT,
	...
	/obj = list(
		...
		"TRAIT_CULT_CONCEALED" = TRAIT_CULT_CONCEALED,
	...
	/obj/item = list(
		...
		"TRAIT_MELEE_WEAPON" = TRAIT_MELEE_WEAPON,
		...
		"TRAIT_SURGERY_INITIATOR" = TRAIT_SURGERY_INITIATOR,
